...
pub enum VmmAction {
    ...
    #[cfg(target_arch = "x86_64")]
    SendCtrlAltDel,
    /// Update the balloon configuration, after microVM start. This can mean either changing
    /// the target number of pages or changing the statistics polling interval.
