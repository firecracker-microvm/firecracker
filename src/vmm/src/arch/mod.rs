...
pub use aarch64::{
    ...
    layout::ACPI_MEM_SIZE, layout::ACPI_MEM_START, layout::CMDLINE_MAX_SIZE, layout::IRQ_BASE,
    layout::IRQ_MAX, ConfigurationError, MMIO_MEM_SIZE, MMIO_MEM_START,
};
...
pub use crate::arch::x86_64::{
    ...
    layout::IOAPIC_ADDR, layout::IRQ_BASE, layout::IRQ_MAX, ConfigurationError, MMIO_MEM_SIZE,
    MMIO_MEM_START,
};
