...
#[tracing::instrument(level = "debug", ret(skip), skip(fd, mpidr))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(reg, num_priority_bits))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(fd, mpidr, state))]
