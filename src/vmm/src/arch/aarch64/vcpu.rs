...
mod tests {
    ...
    fn test_writable_imp_id_regs() {
        ...
        // This is what enables KVM_CAP_ARM_WRITABLE_IMP_ID_REGS when the host
        // kernel offers it; it must run before the vCPU is created.
        vm.arch_pre_create_vcpus(1).unwrap();
        if vm
            .fd()
