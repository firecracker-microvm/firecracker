...
impl Entropy {
    #[tracing::instrument(level = "debug", ret(skip), skip(rate_limiter))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(queues, rate_limiter))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(rate_limiter, bytes))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, iovec))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, features))]
...
mod tests {
    ...
    impl VirtioTestDevice for Entropy {
        #[tracing::instrument(level = "debug", ret(skip), skip(self, queues))]
