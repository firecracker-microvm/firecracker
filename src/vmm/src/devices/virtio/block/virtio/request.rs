...
/// Size of a single discard range descriptor, as fixed by the virtio specification.
const DISCARD_RANGE_SIZE: u32 = 16;
const _: () = assert!(size_of::<DiscardWriteZeroes>() == DISCARD_RANGE_SIZE as usize);
