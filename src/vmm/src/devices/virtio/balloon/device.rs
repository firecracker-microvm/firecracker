...
impl Balloon {
    ...
    pub(crate) fn report_balloon_event_fail(&self, err: BalloonError) {
...
pub(crate) mod tests {
    ...
    fn test_inflate() {
        ...
        // to trigger the inflate event queue.
        {
            ...
            balloon
                ...
                .unwrap_or_else(|e| report_balloon_event_fail(e, balloon.metrics.clone()));
    ...
    fn test_process_reporting() {
        ...
        th.add_scatter_gather(0, &[(0, safe_addr, page_size_chain, 0)]);
    ...
    impl<'a> HintingTestHelper<'a> {
        ...
        fn test_hinting(&mut self, cmd: Option<u32>, expected: u64) {
            ...
            self.th.add_scatter_gather(0, &payload);
