...
#[cfg(test)]
#[tracing::instrument(level = "debug", ret(skip), skip(b, queue_index))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(queue, idx, addr, len, flags))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(queue, idx))]
