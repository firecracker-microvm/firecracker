...
#[tracing::instrument(level = "debug", ret(skip), skip(leaf))]
...
impl CpuidTrait for kvm_bindings::CpuId {
    ...
    #[inline]
    #[tracing::instrument(level = "debug", ret(skip), skip(self, leaf, subleaf))]
...
impl From<core::arch::x86_64::CpuidResult> for CpuidRegisters {
    #[inline]
    #[tracing::instrument(level = "debug", ret(skip), skip(eax, ebx, ecx, edx))]
    fn from(
