...
mod tests {
    ...
    fn test_access_table() {
        ...
        config.set_msg_ctl(0x8000);
        assert_eq!(METRICS.interrupts.config_updates.count(), 2);
        let mut buffer = [0u8; 8];
        ...
        assert_eq!(METRICS.interrupts.config_updates.count(), 0);
        ...
        assert_eq!(METRICS.interrupts.config_updates.count(), 1);
