...
#[tracing::instrument(level = "debug", ret(skip), skip(kernel_image))]
...
impl MockBootSourceConfig {
    ...
    #[cfg(target_arch = "x86_64")]
    #[tracing::instrument(level = "debug", ret(skip), skip(self, kernel_image))]
...
impl MockVmResources {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, vm_config))]
