...
impl SeccompConfig {
    /// Given the relevant command line args, return the appropriate config
    /// type.
    pub fn from_args(
        no_seccomp: bool,
...
/// Retrieve the default filters containing the syscall rules required by
/// `Firecracker` to function. The binary file is generated via the `build.rs`
/// script of this crate.
fn get_default_filters() -> Result<BpfThreadMap, FilterError> {
    // Retrieve, at compile-time, the serialized binary filter generated with
    // seccompiler.
