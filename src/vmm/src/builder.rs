...
pub mod tests {
    ...
    pub(crate) fn default_kernel_cmdline() -> Cmdline {
        linux_loader::cmdline::Cmdline::try_from(DEFAULT_KERNEL_CMDLINE, crate::arch::CMDLINE_MAX_SIZE)
            .unwrap()
    }
    ...
    fn test_load_initrd_unaligned() {
        ...
        let gm = create_guest_mem_at(GuestAddress(crate::arch::PAGE_SIZE as u64 + 1), image.len() * 2);
