...
mod tests {
    ...
    fn test_dump_dirty() {
        ...
        // Second region pages: [clean, clean]
        //
        // Note that bitmaps are larger than the regions.
        // The extra bits must be ignored.
        kvm_dirty_bitmap.insert(0, vec![0b111100]);
        kvm_dirty_bitmap.insert(1, vec![0b111100]);
