...
pub enum KvmVcpuConfigureError {
    ...
    Join(#[from] cpuid::CpuidJoinError),
...
impl KvmVcpu {
    ...
    pub fn configure(
        ...
        let cpuid = match &vcpu_config.custom_cpu_config {
            None => cpuid::Cpuid::try_from(cpuid::RawCpuid::from(cpuid))
