...
fn update_extended_feature_info_entry(
    ...
    entry
        .ecx
        .write_bit(ecx::SSE4A, false)
        .write_bit(ecx::MISALIGN_SSE, false)
        .write_bit(ecx::PREFETCH_BITINDEX, false)
        .write_bit(ecx::MWAIT_EXTENDED, false);

    entry
        .edx
        .write_bit(edx::MMX_EXT, false)
        .write_bit(edx::MMX, false)
        .write_bit(edx::FXSR, false)
        .write_bit(edx::FFXSR, false)
...
fn update_extended_feature_extensions_entry(
    ...
    if entry.index == 0 {
        entry
            .ebx
            .write_bit(ebx::CLZERO, false)
            .write_bit(ebx::RSTR_FP_ERR_PTRS, false)
            .write_bit(ebx::WBNOINVD, false)
            .write_bit(ebx::IBRS_PREFERRED, true)
            .write_bit(ebx::IBRS_PROVIDES_SAME_MODE_PROTECTION, true);
    }
