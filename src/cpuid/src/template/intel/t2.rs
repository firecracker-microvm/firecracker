...
pub(crate) fn update_structured_extended_entry(
    ...
    if entry.index == 0 {
        ...
        entry
            ...
            .write_bit(ecx::AVX512_VBMI2, false)
            .write_bit(ecx::GFNI, false)
            .write_bit(ecx::VAES, false)
            .write_bit(ecx::VPCLMULQDQ, false)
        ...
        entry
            ...
            .write_bit(edx::FSRM, false)
            .write_bit(edx::AVX512_VP2INTERSECT, false);
    }
...
pub(crate) fn update_extended_feature_extensions_entry(
    ...
    if entry.index == 0 {
        entry.ebx.write_bit(ebx::WBNOINVD, false);
    }
