...
pub mod leaf_0x7 {
    ...
    pub mod index0 {
        ...
        pub mod ecx {
            ...
            pub const AVX512_VBMI2: u32 = 6;
            // 7 reserved
            // GFNI = Galois Field New Instructions
            pub const GFNI: u32 = 8;
            // VAES = Vector AES
            pub const VAES: u32 = 9;
            // VPCLMULQDQ = AVX-512 carry-less multiplication
            pub const VPCLMULQDQ: u32 = 10;
        ...
        pub mod edx {
            ...
            // Fast Short REP MOV
            pub const FSRM: u32 = 4;
            // AVX-512 Compute Intersection Between DWORDS/QUADWORDS
            pub const AVX512_VP2INTERSECT: u32 = 8;
...
pub mod leaf_0x80000001 {
    ...
    pub mod ecx {
        pub const SSE4A: u32 = 6; // EXTRQ, INSERTQ, MOVNTSS, and MOVNTSD instruction support
        pub const MISALIGN_SSE: u32 = 7; // Misaligned SEE mode
        pub const PREFETCH_BITINDEX: u32 = 8; // 3DNow! PREFETCH/PREFETCHW instructions
        pub const TOPOEXT_INDEX: u32 = 22; // topology extensions support
        pub const LZCNT_BITINDEX: u32 = 5; // advanced bit manipulation
        pub const MWAIT_EXTENDED: u32 = 29; // MWAITX and MONITORX capability supported
    }

    pub mod edx {
        pub const MMX_EXT: u32 = 22; // AMD extensions to MMX instructions
        pub const MMX: u32 = 23; // MMX instructions
        pub const FXSR: u32 = 24; // FXSAVE and FXRSTOR instructions
        pub const FFXSR: u32 = 25; // FXSAVE and FXRSTOR instruction optimizations
...
pub mod leaf_0x80000008 {
    ...
    pub mod ebx {
        ...
        pub const RSTR_FP_ERR_PTRS: u32 = 2;
        // Write Back and Do Not Invalidate Cache instruction
        pub const WBNOINVD: u32 = 9;
        // IBRS is preferred over software solution
        pub const IBRS_PREFERRED: u32 = 18;
        // IBRS provides Same Mode Protection
        pub const IBRS_PROVIDES_SAME_MODE_PROTECTION: u32 = 19;
    }
    pub mod ecx {
        use crate::bit_helper::BitRange;
