...
pub use block::Block;
pub use device::{IrqType, VirtioDevice};
pub use mmio::MmioTransport;
pub use net::Net;
pub use persist::QueueState;
pub use queue::Queue;
pub use vsock::{Vsock, VsockUnixBackend, TYPE_VSOCK};
...
/// Type for the result of activating a virtio device.
