...
// The virtio queue can hold up to 256 descriptors, but 1 request spreads across
// 2-3 descriptors. So we can use 128 IO_URING entries without ever triggering a
// FullSq Error.
