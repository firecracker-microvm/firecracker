...
#[cfg(test)]
mod tests {
    use crate::virtio::{MAX_BUFFER_SIZE, Net};
    use virtio_gen::virtio_net::{virtio_net_hdr_v1, VIRTIO_NET_F_CSUM, VIRTIO_NET_F_GUEST_CSUM, VIRTIO_NET_F_GUEST_TSO4, VIRTIO_NET_F_GUEST_UFO, VIRTIO_NET_F_HOST_TSO4, VIRTIO_NET_F_HOST_UFO, VIRTIO_F_VERSION_1, VIRTIO_NET_F_MAC};
    use std::mem;
    use crate::virtio::net::device::{vnet_hdr_len, init_vnet_hdr, frame_bytes_from_buf, frame_bytes_from_buf_mut};
