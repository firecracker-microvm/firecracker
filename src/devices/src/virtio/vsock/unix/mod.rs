...
/// This module implements the Unix Domain Sockets backend for vsock - a
/// mediator between guest-side AF_VSOCK sockets and host-side AF_UNIX sockets.
/// The heavy lifting is performed by `muxer::VsockMuxer`, a connection
/// multiplexer that uses `super::csm::VsockConnection` for handling vsock
/// connection states. Check out `muxer.rs` for a more detailed explanation of
/// the inner workings of this backend.
mod muxer;
mod muxer_killq;
mod muxer_rxq;
