...
impl BalloonConfigSpaceState {
    fn from_config_space(config_space: ConfigSpace) -> Self {
        Self {
            num_pages: config_space.num_pages,
            actual_pages: config_space.actual_pages,
        }
    }

    fn create_config_space(&self) -> ConfigSpace {
        ConfigSpace {
...
impl Persist<'_> for Balloon {
    ...
    fn save(&self) -> Self::State {
        BalloonState {
            ...
            config_space: BalloonConfigSpaceState::from_config_space(self.config_space),
    ...
    fn restore(
        ...
        balloon.config_space = state.config_space.create_config_space();
