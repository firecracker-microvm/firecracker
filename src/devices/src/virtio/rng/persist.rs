...
use crate::virtio::rng::{Entropy, Error as EntropyError, NUM_QUEUES, QUEUE_SIZE};
use crate::virtio::{VirtioDeviceState, TYPE_RNG};
...
mod tests {
    ...
    use crate::virtio::rng::device::ENTROPY_DEV_ID;
    use crate::virtio::test_utils::test::create_virtio_mem;
