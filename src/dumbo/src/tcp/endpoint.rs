...
impl Endpoint {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, s, callback))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(status_code, body))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(byte_stream, callback))]
