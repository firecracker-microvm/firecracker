...
impl CgroupHierarchies {
    ...
    fn construct(ver: u8) -> Result<Self, JailerError> {
...
impl CgroupConfigurationBuilder {
    ...
    pub fn new(ver: u8) -> Result<Self, JailerError> {
        Ok(CgroupConfigurationBuilder {
            hierarchies: CgroupHierarchies::construct(ver)?,
            cgroup_conf: match ver {
                1 => Ok(CgroupConfiguration::V1(
                    CgroupConfigurationImpl::<CgroupV1>::new(),
                )),
                2 => Ok(CgroupConfiguration::V2(
                    CgroupConfigurationImpl::<CgroupV2>::new(),
                )),
...
impl CgroupConfiguration {
    pub fn setup(&self) -> Result<(), JailerError> {
        match self {
            Self::V1(ref conf) => conf.setup(),
            Self::V2(ref conf) => conf.setup(),
        }
    }
}
