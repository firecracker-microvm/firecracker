    ...
    pub fn add_cgroup_property(
        ...
        match self.version {
            1 => {
                ...
                let CgroupConfiguration::V1(cgroup_conf_v1) = &mut self.cgroup_conf else {
                    unreachable!()
                };
...
mod tests {
    ...
    fn test_cgroup_conf_v2_write_value() {
        ...
        builder
            ...
            .unwrap();
        let CgroupConfiguration::V2(cg_conf) = builder.build() else {
            unreachable!()
        };
    ...
    fn test_cgroup_conf_v1_write_value() {
        ...
        builder
            ...
            .unwrap();
        let CgroupConfiguration::V1(cg_conf) = builder.build() else {
            unreachable!()
        };
        ...
        MockCgroupFs::create_file_with_contents(cg_root.join("cpuset.mems"), "0-1").unwrap();
        MockCgroupFs::create_file_with_contents(cg_root.join("fc_test_cgv1/cpuset.mems"), "0-1")
            .unwrap();
        MockCgroupFs::create_file_with_contents(
