...
use crate::arch::fadt_platform_init;
use crate::sdt::{Sdt, SdtHeader};
use crate::{
    checksum, GenericAddress, Result, ACPI_PM1_CNT_LEN, ACPI_PM1_EVT_LEN,
    ACPI_REGISTERS_BASE_ADDRESS, ACPI_SCI_INT,
};
...
pub struct Fadt {
    ...
    _mon_alrm: u8,
    _century: u8,
    pub(crate) _iapc_boot_arch: u16,
    _reserved_2: u8,
    flags: u32,
    _reset_reg: GenericAddress,
    _reset_value: u8,
    pub(crate) _arm_boot_arch: u16,
