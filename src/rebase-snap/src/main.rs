...
#[tracing::instrument(level = "debug", skip(arg_parser))]
...
#[tracing::instrument(level = "debug", ret(skip), skip(base_file, diff_file))]
...
mod tests {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(file, expected_content))]
