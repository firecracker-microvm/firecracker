...
{
  int has_vm_gen_counter = vmclock->flags & VMCLOCK_FLAG_VM_GEN_COUNTER_PRESENT;
  int has_notifications = vmclock->flags & VMCLOCK_FLAG_NOTIFICATION_PRESENT;

  printf("VMCLOCK_FLAG_VM_GEN_COUNTER_PRESENT: %s\n", has_vm_gen_counter ? "true" : "false");
  printf("VMCLOCK_FLAG_NOTIFICATION_PRESENT: %s\n", has_notifications ? "true" : "false");
