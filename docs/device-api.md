...
| Endpoint                  | keyboard | serial console | virtio-block | vhost-user-block | virtio-net | virtio-vsock | virtio-rng | virtio-mem |
| ------------------------- | :------: | :------------: | :----------: | :--------------: | :--------: | :----------: | :--------: | :--------: |
| `boot-source`             |    O     |       O        |      O       |        O         |     O      |      O       |     O      |     O      |
| `cpu-config`              |    O     |       O        |      O       |        O         |     O      |      O       |     O      |     O      |
| `drives/{id}`             |    O     |       O        |    **R**     |      **R**       |     O      |      O       |     O      |     O      |
| `hotplug/memory`          |    O     |       O        |      O       |        O         |     O      |      O       |     O      |   **R**    |
...
| Schema                    | Property           | keyboard | serial console | virtio-block | vhost-user-block | virtio-net | virtio-vsock | virtio-rng | virtio-mem |
| ------------------------- | ------------------ | :------: | :------------: | :----------: | :--------------: | :--------: | :----------: | :--------: | :--------: |
