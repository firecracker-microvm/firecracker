...
use super::super::transformer::common::use_host_cpuid_function;
use super::*;
...
pub fn update_structured_extended_entry(
    ...
    use super::super::cpu_leaf::leaf_0x7::index0::*;
...
pub fn update_largest_extended_fn_entry(
    ...
    use super::super::cpu_leaf::leaf_0x80000000::*;
...
pub fn update_extended_feature_info_entry(
    ...
    use super::super::cpu_leaf::leaf_0x80000001::*;
...
pub fn update_amd_features_entry(
    ...
    use super::super::cpu_leaf::leaf_0x80000008::*;
...
pub fn update_extended_apic_id_entry(
    ...
    use super::super::cpu_leaf::leaf_0x8000001e::*;
...
mod tests {
    ...
    fn test_update_largest_extended_fn_entry() {
        use super::super::super::cpu_leaf::leaf_0x80000000::*;
    ...
    fn check_update_amd_features_entry(cpu_count: u8, smt: bool) {
        use super::super::super::cpu_leaf::leaf_0x80000008::*;
    ...
    fn check_update_extended_apic_id_entry(
        ...
        use super::super::super::cpu_leaf::leaf_0x8000001e::*;
