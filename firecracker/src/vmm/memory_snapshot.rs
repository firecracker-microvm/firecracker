...
pub enum Error {
    ...
    CreateMemory(#[from] crate::vm_memory_ext::Error),
    /// Cannot create region.
    #[error("Cannot create memory region: {0:?}")]
    CreateRegion(#[from] crate::vm_memory_ext::MmapRegionError),
...
impl SnapshotMemory for GuestMemoryMmap {
    ...
    fn restore(
        ...
        crate::vm_memory_ext::create_guest_memory(&regions, track_dirty_pages)
...
mod tests {
    ...
    fn test_describe_state() {
        ...
        let guest_memory =
            crate::vm_memory_ext::create_guest_memory(&mem_regions[..], true).unwrap();
