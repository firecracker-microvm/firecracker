...
- [#5485](https://github.com/firecracker-microvm/firecracker/pull/5485): Fixed a
  bug causing a read/write from an iovec to be duplicated when receving an error
  on an iovec other than the first. This caused a data curruption issue in the
  vsock device starting from guest kernel 6.17.
